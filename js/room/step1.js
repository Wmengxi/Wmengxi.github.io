(function() {
  angular.module('myApp').controller('stepCtrl', stepCtrl);
  ...
  function stepCtrl($scope) {
    ...
    $(document).ready(function() {
      $("div.Box2").show();
      $("div.Box3").hide();
      $("div.Box3-message").hide();
      $("div.Box2-message").hide();
      $('a.icon-globe').click(function() {
        $("div.Box3").hide();
        $("div.Box2").show();
      });
      $('button.Button1:first').click(function() {
        $("div.Box3").show();
        $("div.Box2").hide();
      });
      $("div.hi-icon-wrap").click(function() {
        if ($("div.Box2").is(":hidden")) {
          $("div.Box3-message").show();
          $("div.Box2-message").hide();
        }
        if ($("div.Box3").is(":hidden")) {
          $("div.Box2-message").show();
          $("div.Box3-message").hide();
        }
      });
      ...
      $("div.hi-icon-wrap").click(function(event) {
